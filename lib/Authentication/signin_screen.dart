  ...
  Future readDataAndSetDataLocally(User currentUser) async {
    await FirebaseFirestore.instance
      ...
      if (snapshot.exists) {
        ...
        var userCardArray = snapshot.data()!["userCard"];
        List<String> userCardList = List<String>.from(userCardArray);
        await sharedPreferences!.setStringList("userCard", userCardList);
